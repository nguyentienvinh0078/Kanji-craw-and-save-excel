...
def get_word_data(driver, word):
    for __ in range(3):
        try:
            ...
            wait_draw_time = 4
            if stroke > 4: wait_draw_time = int(stroke * 2)
            if stroke > 10: wait_draw_time = int(stroke * 1.6)
            ...
            word_image_svg_code = word_image_svg_code.replace('rgba(0, 0, 0', 'rgba(47, 187, 80')
            word_image_svg_code = word_image_svg_code.replace('rgba(191, 191, 191', 'rgba(47, 187, 80')
